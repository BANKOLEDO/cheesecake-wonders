...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="scroll-mt-20 pt-8 md:py-6 mx-7 md:mx-10 lg:px-20 flex flex-col md:flex-row items-center md:justify-between text-center mt-20"
    >  
      <div className="flex flex-col text-center md:items-start md:text-left lg:p-2">
        <SplitText
            text="Bite The World of Cheesecake Wonders"
            className="text-xl xs:text-3xl xmd:text-4xl md:text-4xl xl:text-5xl 2xl:text-5xl font-bold text-primary mx-4 md:mx-0 text-center hover:text-orange-900"
            delay={100}
            duration={0.9}
            ease="power3.out"
            splitType="words"
